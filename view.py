class View:
    ...
    def tampilkan_barang(barang_list):
        ...
        for barang in barang_list:
            print("{:<10} {:<20} {:<10.2f}".format(barang.id_barang, barang.nama, barang.harga))
    ...
    @staticmethod
    def tampilkan_total_harga(barang_list, total_harga):
        if not barang_list:
            print("Tidak ada barang dalam daftar.")
            return
        print("\nDaftar Barang dan Total Harga:")
        print("{:<10} {:<20} {:<10}".format('ID', 'Nama', 'Harga'))
        print("-" * 40)
        for barang in barang_list:
            print("{:<10} {:<20} {:<10.2f}".format(barang.id_barang, barang.nama, barang.harga))
        print("-" * 40)
        print(f"{'Total':<30} {total_harga:.2f}")
